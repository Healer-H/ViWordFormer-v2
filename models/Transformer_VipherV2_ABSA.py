...
class TransformerEncoder_ABSA_ViPherV2(nn.Module):
    def __init__(self, config, vocab: Vocab):
        super(TransformerEncoder_ABSA_ViPherV2, self).__init__()
        # Model configuration
        ...
        self.cls_head = Aspect_Based_SA_Output(
            config.model.dropout, self.d_model, config.model.num_output, config.model.num_categories
        )
